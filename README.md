...
**APIs.json:** [https://raw.githubusercontent.com/api-evangelist/aws-app-runner/refs/heads/main/apis.yml](https://raw.githubusercontent.com/api-evangelist/aws-app-runner/refs/heads/main/apis.yml)
...
- **Base URL:** `https://apprunner.{region}.amazonaws.com`
...
- [OpenAPI](openapi/aws-app-runner-openapi.yml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [Postman Collection](collections/aws-app-runner.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/aws-app-runner.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)
...
- [F A Q](https://aws.amazon.com/apprunner/faqs/)
...
- [Spectral Rules](rules/aws-app-runner-spectral-rules.yml)
- [Vocabulary](vocabulary/aws-app-runner-vocabulary.yaml)
- [Features](undefined)
- [Use Cases](undefined)
